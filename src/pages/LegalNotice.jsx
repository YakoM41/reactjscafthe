...
function LegalNotice() {
  return (
    <div className="legal-page-container">
      ...
      <p>
        <strong>Dénomination sociale :</strong> {editorInfo.name}<br />
        <strong>Forme juridique :</strong> {editorInfo.legalForm}<br />
        <strong>Capital social :</strong> {editorInfo.capital}<br />
        <strong>Adresse du siège social :</strong> {editorInfo.address}<br />
        <strong>Téléphone :</strong> {editorInfo.phone}<br />
        <strong>Adresse e-mail :</strong> {editorInfo.email}<br />
        <strong>Numéro d'immatriculation au RCS :</strong> {editorInfo.rcs}<br />
        <strong>Numéro de TVA intracommunautaire :</strong> {editorInfo.vat}<br />
        <strong>Directeur de la publication :</strong> {editorInfo.publicationDirector}
      </p>

      <h2>2. Hébergeur du Site</h2>
      <p>
        <strong>Nom de l'hébergeur :</strong> {hostInfo.name}<br />
        <strong>Adresse :</strong> {hostInfo.address}<br />
        <strong>Site web :</strong> {hostInfo.website}
      </p>
